...
/**
 * Returns the correct throw type for Pepe.
 * @param {Character} character - Player character.
...
/**
 * Returns the throw Y position for Pepe.
 * @param {Character} character - Player character.
 * @returns {number} Throw start Y position.
 */
...
/**
 * Returns the throw X position for Pepe.
 * @param {Character} character - Player character.
 * @returns {number} Throw start X position.
 */
